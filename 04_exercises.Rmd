...
```{r}
palette_mpls_all <- colorNumeric("Blues", domain = mpls_all$prop_stops)
...
There were a higher proportion of suspicious stops in the south east neighborhoods of Minneapolis than in the north.   
