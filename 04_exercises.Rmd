...
From this map, we see that Joint Ventures outlets are owned mostly in South & East Asia, while a licensed or company owned location is prevalent in the Americas.
...
ggmap(twin_cities)+
  geom_point(data = starbucks_us_state, 
...
When the zoom is a larger number, it zooms out the map, so we see a larger area being covered. But when it is smaller it zooms into the map.
...
ggmap(twin_cities)+
  geom_point(data = starbucks_us_state, 
             aes(x = Longitude, y = Latitude, color = "red"))+ 
  annotate(geom = "text", x = -93.1874, y = 44.926, label = "Macalester College")+
...
ayushi_fav_places <- tibble(
  place = c("Home", "Macalester College", "Target Center", 
            "Groveland Tap", "Milkjam Creamery", "Grand Ole Creamery",
            "Shish", "Bde Maka Ska", "Hidden Falls", "Andale Taqueria", "Mississippi River Blvd"),
  long = c(-93.169384, -93.168953, -93.276138, 
           -93.177868, -93.287807, -93.131912, 
           -93.170647, -93.311125, -93.193041, -93.278789, -93.197105),
  lat = c(44.933867, 44.938218, 44.979630,
          44.934236, 44.952570, 44.939944, 
          44.940144, 44.946084, 44.906385, 44.863619, 44.921730 ),
  top_3 = c("True", "False", "True", 
            "False", "False", "False", 
            "False", "False", "False", "False", "True")
  ) 

palette1<-
colorFactor(palette = "viridis", domain = ayushi_fav_places$top_3 )
...
Stations_new %>% 
  ...
  mutate(casual_user = total_departures/n())
